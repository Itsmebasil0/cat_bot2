...
if(pattern.test(message.message)){
       await message.client.sendMessage(message.jid, fs.readFileSync('./basilsers' + a + '.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio, quoted: message.data, ptt: true})
}
});
    }
